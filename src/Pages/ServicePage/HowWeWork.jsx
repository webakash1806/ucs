...
export default function HowWeWork() {
    return (
        <div className=" lg:py-8 md:py-12 py-10 bg-gray-100">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center md:gap-14 gap-8 mt-8">
                <div className="flex relative flex-col items-center text-center max-w-xs">
                    ...
                    <p className="text-gray-500 mt-2 md:text-base text-sm">
                        Plan your trip with UCS Cab and enjoy a comfortable and hassle-free ride.
                    </p>
                ...
                <div className="flex flex-col items-center text-center max-w-xs">
                    ...
                    <h3 className="text-xl font-semibold mt-4">Reliable & Comfortable Rides</h3>
                    <p className="text-gray-500 mt-2 md:text-base text-sm">
                        Experience hassle-free travel with UCS Cab. Safe, affordable, and always on time.
                    </p>
