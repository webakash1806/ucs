    ...
    return (
        <footer className="relative flex flex-col items-start justify-center overflow-x-hidden">
                        ...
                        <div className="w-full mb-8 xl:w-1/4 md:w-1/3 md:mb-0">
                            <div className="text-white">
                                ...
                                <li className="text-[#e0e4ff] leading-8 text-[0.9rem] hover:text-white">
                                    ...
                                    <li className="text-[#e0e4ff] leading-8 text-[0.9rem] hover:text-white">
                                        <Link to="/taxi/local">Local Taxi</Link>
                                    </li>
                                    <li className="text-[#e0e4ff] leading-8 text-[0.9rem] hover:text-white">
                                        <Link to="/taxi/round-trip">Round Trip Taxi</Link>
                                    </li>
                                    <li className="text-[#e0e4ff] leading-8 text-[0.9rem] hover:text-white">
                                        <Link to="/taxi/one-way">One-way Taxi</Link>
                                    </li>
                                    ...
                                    <li className="text-[#e0e4ff] leading-8 text-[0.9rem] hover:text-white">
                                        <Link to="/taxi/outstation">OutStation</Link>
                                    </li>
                        ...
                        <div className="w-full xl:w-1/6 md:w-1/3">
                            <div className="text-white">
                                ...
                                <ul>
                                    ...
                                    <li className="text-[#e0e4ff] leading-8 text-[0.9rem] hover:text-white">
                                        <Link to="/packages">Holiday Package</Link>
                                    </li>
                                    <li className="text-[#e0e4ff] leading-8 text-[0.9rem] hover:text-white">
            ...
            <div className="flex w-full bg-[#000a12] items-center justify-around gap-1 flex-wrap text-[1rem] py-4 text-[#fff]">
                ...
                <span className="text-center text-[0.9rem] w-[18rem]">© 2025 UCS All rights reserved.</span>
